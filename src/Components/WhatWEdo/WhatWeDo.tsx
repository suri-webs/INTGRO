...
export default function WhatWeDo() {
    return (
        <section className="w-full  z-89 h-[700px] max-lg:h-full " >
            ...
            <div className="w-full h-full flex flex-col gap-5 max-md:gap-10 justify-center items-center text-white">
                ...
                <div className="w-full h-[600px] max-md:h-full max-md:gap-10 max-md:flex-col flex justify-center items-center">
                    {WhatWEdoData.map((items, index) => {
                        return (<div key={index} className="flex  flex-col w-[27%] max-md:w-[90%] max-md:gap-3  gap-4 justify-center items-center">
                            <div className={`w-[120px] h-[120px] max-md:w-[100px] max-md:h-[100px] flex justify-center items-center bg-[#2E2D2D] transition-all duration-500 hover:bg-[#0054D6] ${items.cssStyle}`} >
