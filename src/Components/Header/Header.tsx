    ...
    return (
        <header className="relative h-full  w-full gap-30 max-md:gap-20 pt-[40px] flex flex-col justify-between bg-[#030308]">
            ...
            <div className=" w-full h-[700px] max-sm:h-[100%] flex items-center justify-center gap-10 max-lg:w-full max-lg:flex-col z-79 ">
                ...
                <div className="w-[40%]  h-[90%] max-sm:h-[280px] max-lg:w-full flex items-center justify-center">
                    <div className="w-[70%] max-lg:w-[80%] max-sm:h-fit max-md:gap-5 flex flex-col gap-10">
                        ...
                        <div className="flex items-center gap-5 max-sm:flex-wrap">
                            <button className="px-10 py-2 text-[20px] text-white bg-[#DF50E4] hover:bg-white hover:text-black bebas-neue flex transition-all duration-300 items-center gap-2">
                                SERVICES <ArrowRight className="w-5" />
                            </button>
                            <button className="w-[50px] h-full py-[10px] border border-amber-50 flex items-center justify-center transition-all duration-100 hover:border-none ease-in hover:bg-[#DF50E4]">
                ...
                {/* Right */}
                <div className="w-[46%] h-[98%] max-sm:w-[85%] max-lg:w-[80%] bg-[url(/images/Header-img1.jpg)] bg-cover bg-center flex items-center max-sm:h-[250px] ">
                    <Image className="relative -left-20 max-sm:w-[35%] max-lg:w-[35%] max-md:w-[40%] max-sm:-left-5 max-lg:-left-15" src="/images/Header-Img2.jpg" alt="Feature" width={300} height={0} />
                </div>
            </div>
